    ...
    public class TheSupportedFormatsProperty
    {
        ...
        public void ShouldContainTheCorrectNumberOfFormats()
        {
            ...
            if (Runtime.IsWindows)
                Assert.Equal(282, formatsCount);
            else
                Assert.Equal(279, formatsCount);
        }
        ...
        public void ShouldContainTheCorrectNumberOfReadableFormats()
        {
            ...
            List<MagickFormat> expectedFormats = [
                ...
                MagickFormat.Text,
                MagickFormat.Tga,
                MagickFormat.ThreeFr,
                MagickFormat.ThreeG2,
                MagickFormat.ThreeGp,
                MagickFormat.Tif,
                MagickFormat.Tiff,
                MagickFormat.Tiff64,
                MagickFormat.Tile,
            ...
            var missingFormats = expectedFormats.Except(readableFormats);
            Assert.False(missingFormats.Any(), "Missing formats detected in readable formats: " + string.Join(", ", missingFormats.Select(f => f.ToString())));
        }
        ...
        public void ShouldContainTheCorrectNumberOfWritableFormats()
        {
            ...
            List<MagickFormat> expectedFormats = [
                ...
                MagickFormat.Six,
                MagickFormat.Sixel,
                MagickFormat.SparseColor,
                MagickFormat.StrImg,
                MagickFormat.Svg,
                MagickFormat.Svgz,
                MagickFormat.Tga,
                MagickFormat.Thumbnail,
                MagickFormat.Tif,
                MagickFormat.Tiff,
                MagickFormat.Tiff64,
                MagickFormat.Txt,
            ...
            if (Runtime.IsWindows)
                expectedFormats.AddRange([MagickFormat.Clipboard]);

            var extraFormats = writableFormats.Except(expectedFormats);
            Assert.False(extraFormats.Any(), "Extra formats detected in writable formats: " + string.Join(", ", extraFormats.Select(f => f.ToString())));

            var missingFormats = expectedFormats.Except(writableFormats);
            Assert.False(missingFormats.Any(), "Missing formats detected in writable formats: " + string.Join(", ", missingFormats.Select(f => f.ToString())));
        }
